...
export default function Home() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      text: "Thanks to Krishi Bandhu with that, I was able to sell my commodity at great offers with secure transactions. Very helpful in providing latest market rates also.",
      author: "Sarjo Baldeh",
              ...
              <div>
                ...
                <ul className="space-y-2 mb-4">
                  ...
                  <li className="flex items-center text-gray-600">
                    ...
                    <a href="tel:+601128802174" className="hover:text-green-600">+601128802174</a>
                  </li>
                </ul>
