      ...
      <div className="pt-24">
            ...
            <div className="flex-1 flex justify-center lg:justify-end">
              <div className="relative">
                ...
                <div className="absolute top-8 right-0 w-64 h-96 bg-white rounded-3xl shadow-2xl transform -rotate-6">
                  <div className="absolute inset-0 bg-gradient-to-b from-amber-50 to-white rounded-3xl p-4">
                    <div className="bg-amber-600 text-white p-3 rounded-t-3xl -m-4 mb-4">
        ...
        <section className="py-16 bg-amber-700 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 text-amber-100">Download the Baykart app today and join thousands of farmers already using our platform.</p>
