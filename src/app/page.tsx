...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-green-50 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`text-white space-y-8 transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up delay-700">
                <button className="group relative px-8 py-4 bg-gray-400 text-gray-600 rounded-2xl font-semibold shadow-2xl opacity-50 cursor-not-allowed">
                ...
                <a 
                  ...
                  className="group relative px-8 py-4 bg-black/20 backdrop-blur-sm text-white border border-white/30 rounded-2xl font-semibold shadow-2xl hover:bg-white/10 transition-all duration-300 transform hover:scale-105 hover:-rotate-1"
                >
                  <div className="relative flex items-center gap-3">
      ...
      <section id="how-it-works" ref={featuresRef} className="py-20 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 scroll-animate">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 animate-slide-up">
              How It Works
          ...
          <div className="text-center scroll-animate">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up delay-400">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="group relative px-8 py-4 bg-white text-green-700 rounded-2xl font-semibold shadow-2xl hover:shadow-green-500/25 transition-all duration-300 transform hover:scale-105 hover:rotate-1"
              >
